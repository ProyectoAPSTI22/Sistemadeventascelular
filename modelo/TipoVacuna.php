...
class TipoVacuna extends Modelo implements TablaInterface {
    private $_id;   # Nuestro (PK)
    private $_tipo;
    private $_bd;
    const TABLA = 'tiposvacunas';
    #Constructor
    ...
    public function leer($todo=true){
        ...
        if (!$todo)
            $sql .=" WHERE idtiposvacunas=".$this->_id.";";
    ...
    private function setPropiedades ($registro){
        $this->_id= $registro["idtiposvacunas"];
